    ...
    def __init__(
        ...
        **kwargs,
        ...
        for layer_idx in range(n_layers):
            ...
            elif layer_module == gnn.SuperGATConv:
                heads = kwargs.get("heads", 4)
                concat = kwargs.get("concat", False)
                layer = layer_module(
                    d1, d2, heads=heads, concat=concat, attention_type="SD"
                )
            else:
...
if __name__ == "__main__":
    ...
    data = PPIDataLoadingUtil(
        "datasets/tadw-sc/collins_2007/colins2007.csv", load_embeddings=False
    )
